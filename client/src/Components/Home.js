                ...
                <div className="container">
                    <div className="col1">
                        ...
                        <h2>Qu’est-ce que la maladie 
                            d’Alzheimer?</h2>
                        <h3></h3>
                        <Link to='/info'><h4 className="cole1"><a href="#">En savoir plus sur l'Alzheimer</a></h4></Link>
                    </div>
                    <div className="col2">
                        <img src={old}></img>
                        <h2>Rejoignez notre blog</h2>
                        <h3></h3>
                      <Link to='Signup'>  <h4 className="cole2"> <a href="#">S'inscrire</a></h4></Link>
                    </div>

                    <div className="col3">
                        <img src={cursor}></img>
                        <h2>QUE FAIRE LORSQU’UN PROCHE EST EN PERTE D’AUTONOMIE ? </h2>
                        <h3></h3>
                       <Link to='about'> <h4 className="cole3"><a href=""> Numéro utiles </a></h4></Link>
                    </div>
                </div>
